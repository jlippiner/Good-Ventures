module NumberToWords
  module Numeric
    ...
    module InstanceMethods
      ...
      def teens
        %w[ ten eleven tweleve thirteen fourteen fifteen sixteen seventeen eighteen nineteen]
      end

      def twenties
        %w[ twenty twentyone veintidos veintitres veinticuatro veinticinco veintiseis veintisiete veintiocho veintinueve ]
      end
